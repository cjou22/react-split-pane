            ...
            if (allowResize && active) {
                ...
                if (ref) {
                    ...
                    if (node.getBoundingClientRect) {
                        ...
                        var width = Number.isNaN(ref.state.size) ? node.getBoundingClientRect().width : ref.state.size;
                        var height = Number.isNaN(ref.state.size) ? node.getBoundingClientRect().height : ref.state.size;
                        ...
                        var newSize = this.currentState.size - newPosition;
